...
As of v8.15.x node-postgres supporters the **ECMAScript Module** (ESM) format. This means you can use `import` statements instead of `require` or `import pg from 'pg'`.
